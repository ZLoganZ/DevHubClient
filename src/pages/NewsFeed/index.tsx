...
import LoadingNewsFeed from "@/components/Loading/LoadingNewsFeed";
import { useTheme } from "@/components/ThemeProvider";
import { useAllPostsData } from "@/hooks/DataProvider";
...
const NewsFeed = () => {
  ...
  const { isLoading, allPost, userInfo } = useAllPostsData();
