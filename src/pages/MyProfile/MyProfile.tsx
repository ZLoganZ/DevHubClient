          ...
          <Row>
            <Col span={24} className='avatar_cover relative'>
              <div
                ...
                style={{
                  backgroundImage: `url("${
                    getImageURL(currentUserInfo.cover_image) ||
            ...
            <Col offset={isXsScreen ? 0 : 3} span={isXsScreen ? 24 : 18}>
                ...
                <Col offset={isXsScreen ? 1 : 6} span={isXsScreen ? 16 : 12}>
                  ...
                  <div className='position mt-2'>
                    ...
                    <span
                      ...
                      currentUserInfo.experiences.length > 0
              ...
              <div className='id_address_join xs:pl-3'>
                ...
                <span className='join'>
                  ...
                  Joined{' '}
                  {format(new Date(currentUserInfo.createdAt), 'MMM yyyy')}
                </span>
              </div>
              ...
              <div className='follow mt-5 xs:pl-3'>
                <span className='follower item mr-2'>
                  <span className='mr-1'>
                    {currentUserInfo?.follower_number || 0}
                  </span>{' '}
                  {currentUserInfo?.follower_number > 1
                    ? 'Followers'
                    : 'Follower'}
                </span>
                <span className='following item mr-2'>
                  <span className='mr-1'>
                    {currentUserInfo?.following_number || 0}
                  </span>{' '}
                  {currentUserInfo?.following_number > 1
                    ? 'Followings'
                    : 'Following'}
                </span>
                <span className='post mr-2'>
                  <span className='mr-1'>
                    {currentUserInfo?.post_number || 0}
                  </span>{' '}
                          ...
                          {currentUserInfo.repositories.length !== 0 && (
                            <div className='w-8/12 mt-5 xs:w-full'>
                              ...
                              <div className='flex flex-wrap justify-between mt-5'>
                                {currentUserInfo.repositories.map(
                                  (item, index) => {
